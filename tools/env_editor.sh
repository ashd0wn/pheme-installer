...
##############################################################################
# Chmod: chmod +x /root/pheme_installer/tools/env_editor.sh
# Start with: /root/pheme_installer/tools/env_editor.sh
#
# Check here: https://docs.pheme.com/en/getting-started/settings
#
# Interactive Mode
#
# --add variable=value
