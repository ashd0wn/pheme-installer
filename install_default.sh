...
##############################################################################
# Pheme Installer / Default, Latest Stable
##############################################################################
...
echo -en "
***************************************************************************
Whup! Whup! Pheme Installation is complete.
...
Please do not disturb the Pheme Team with errors in this Installer.
The Developers only support the Docker variant!

If needed, you will find a log of your installations process here: $installerHome/pheme_installer.log
Your credentials where also saved to: $installerHome/pheme_details.txt
...
***************************************************************************\n
" | tee $installerHome/pheme_details.txt
